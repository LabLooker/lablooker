...
const ICD10_CODES = [
  ...
  // Additional codes for extended mappings
  { code: 'M31.9',   description: 'Necrotizing vasculopathy, unspecified' },
  { code: 'M31.3',   description: 'Wegener granulomatosis without renal involvement' },
  { code: 'M31.0',   description: 'Hypersensitivity angiitis' },
  { code: 'N04.9',   description: 'Nephrotic syndrome with unspecified morphologic changes' },
  { code: 'M35.00',  description: 'Sjogrens syndrome, unspecified' },
  { code: 'M08.1',   description: 'Juvenile ankylosing spondylitis' },
  { code: 'M62.89',  description: 'Other specified disorders of muscle' },
  { code: 'D68.61',  description: 'Antiphospholipid syndrome' },
  { code: 'D68.59',  description: 'Other primary thrombophilia' },
  ...
  { code: 'D69.1',   description: 'Qualitative platelet defects' },
  { code: 'Z79.01',  description: 'Long-term (current) use of anticoagulants' },
  { code: 'D68.00',  description: 'Von Willebrand disease, unspecified' },
  { code: 'Z67.10',  description: 'Type A blood, Rh positive' },
  { code: 'Z36',     description: 'Encounter for antenatal screening of mother' },
  { code: 'D59.1',   description: 'Other autoimmune hemolytic anemias' },
  ...
  { code: 'D57.0',   description: 'Sickle-cell anemia with crisis' },
  { code: 'E26.9',   description: 'Hyperaldosteronism, unspecified' },
  { code: 'E25.0',   description: 'Congenital adrenogenital disorders associated with enzyme deficiency' },
  ...
  { code: 'B27.00',  description: 'Gammaherpesviral mononucleosis without complication' },
  { code: 'B27.09',  description: 'Gammaherpesviral mononucleosis with other complications' },
  ...
  { code: 'A60.09',  description: 'Herpesviral infection of other urogenital tract' },
  { code: 'J10.1',   description: 'Influenza due to other identified influenza virus with other respiratory manifestations' },
  { code: 'A49.3',   description: 'Mycoplasma infection, unspecified site' },
  ...
  { code: 'A59.00',  description: 'Urogenital trichomoniasis, unspecified' },
  { code: 'N39.0',   description: 'Urinary tract infection, site not specified' },
  { code: 'E07.9',   description: 'Disorder of thyroid, unspecified' },
  { code: 'K50.90',  description: 'Crohns disease of small intestine without complications' },
  { code: 'E83.10',  description: 'Disorder of iron metabolism, unspecified' },
  ...
  { code: 'E13.10',  description: 'Other specified diabetes mellitus with ketoacidosis without coma' },
  { code: 'E87.8',   description: 'Other disorders of electrolyte and fluid balance' },
  { code: 'E87.4',   description: 'Mixed disorder of acid-base balance' },
  { code: 'R09.2',   description: 'Respiratory arrest' },
  { code: 'T57.0X1A', description: 'Toxic effect of arsenic and its compounds, accidental, initial encounter' },
  { code: 'T56.3X1A', description: 'Toxic effect of cadmium and its compounds, accidental, initial encounter' },
  { code: 'T56.91XA', description: 'Toxic effect of unspecified metals, accidental, initial encounter' },
  { code: 'T56.0X1A', description: 'Toxic effect of lead and its compounds, accidental, initial encounter' },
  { code: 'F31.9',   description: 'Bipolar disorder, unspecified' },
  { code: 'T57.2XXA', description: 'Toxic effect of manganese and its compounds, accidental, initial encounter' },
  { code: 'T56.1X1A', description: 'Toxic effect of mercury and its compounds, accidental, initial encounter' },
  { code: 'E61.5',   description: 'Molybdenum deficiency' },
  ...
  { code: 'G31.2',   description: 'Degeneration of nervous system due to alcohol' },
  ...
  { code: 'E54',     description: 'Ascorbic acid deficiency (Scurvy)' },
  { code: 'E56.0',   description: 'Vitamin E deficiency' },
  { code: 'G31.81',  description: 'Alpers disease' },
  { code: 'E56.1',   description: 'Vitamin K deficiency' },
  { code: 'D68.4',   description: 'Acquired coagulation factor deficiency' },
  { code: 'C88.0',   description: 'Waldenstroms macroglobulinemia' },
  ...
  { code: 'A92.30',  description: 'West Nile virus infection, unspecified' },
  ...
  { code: 'N90.3',   description: 'Dysplasia of vulva, unspecified' },
