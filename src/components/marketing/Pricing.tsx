  ...
  async function handlePremiumCheckout() {
    ...
    try {
      const priceId = isAnnual
        ? (process.env.NEXT_PUBLIC_STRIPE_ANNUAL_PRICE_ID || 'price_1TBfEZA9M54KyGCTgCsroNci')
        : (process.env.NEXT_PUBLIC_STRIPE_MONTHLY_PRICE_ID || 'price_1TBfEbA9M54KyGCT6aq2io6a')
