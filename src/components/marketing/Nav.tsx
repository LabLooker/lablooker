    ...
    <header className="fixed top-0 z-50 w-full border-b border-[#e0ebe9] bg-[#faf8f5]/80 backdrop-blur-xl">
      <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
        ...
        <div className="hidden items-center gap-8 md:flex">
          {APP_CONFIG.nav.filter(l => l.label !== 'Track Results').map((link) => (
            <Link
              key={link.href}
              href={link.href}
              className="text-sm text-[#577572] transition-colors hover:text-[#1a2e2b] flex items-center gap-1.5"
            >
              {link.label}
            </Link>
          ))}
            ...
            <div className="relative" ref={accountRef}>
              ...
              {accountOpen && (
                <div className="absolute right-0 mt-2 w-48 rounded-xl border border-[#e0ebe9] bg-white py-1 shadow-lg">
                  ...
                  >
                    <svg className="h-4 w-4 text-[#577572]" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                  ...
                  <button
                    ...
                    className="flex w-full items-center gap-2 px-4 py-2.5 text-sm text-[#577572] hover:bg-[#faf8f5] hover:text-[#1a2e2b]"
                  >
        ...
        <div className="flex items-center gap-3 md:hidden">
          <Link
            href="/search"
            className="flex h-9 w-9 items-center justify-center rounded-lg text-[#577572] hover:text-[#2d6a5e] hover:bg-[#2d6a5e]/5 transition-colors"
            aria-label="Search"
          >
          ...
          <button
            className="text-[#577572] hover:text-[#1a2e2b]"
