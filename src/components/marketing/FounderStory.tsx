  ...
  return (
    <section className="py-16 sm:py-24">
      <div className="mx-auto max-w-3xl px-6">
        <div className="rounded-2xl border-[1.5px] border-[#e0ebe9] bg-white p-8 sm:p-10">
          <div className="flex items-center gap-3 mb-5">
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[rgba(45,106,94,0.1)]">
          ...
          <p className="mt-6 text-sm font-medium text-[#577572]">
            — Rosa, Founder
          </p>
        </div>
      </div>
