        ...
        {status === 'success' ? (
          ...
          <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-3 sm:flex-row sm:gap-2 sm:justify-center">
            <input
              ...
              className="h-12 flex-1 rounded-xl border border-[#e0ebe9] bg-white px-4 text-[#1a2e2b] placeholder-[#577572] focus:border-[#2d6a5e] focus:outline-none focus:ring-1 focus:ring-[#2d6a5e] sm:max-w-sm"
            />
            <button
              type="submit"
