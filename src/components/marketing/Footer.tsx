  ...
  return (
    <footer className="border-t border-[#e0ebe9] bg-white">
      <div className="mx-auto max-w-7xl px-6 py-16">
        ...
        <p className="mt-12 text-[11px] leading-relaxed text-[#a3bfbb]">
          <strong className="text-[#8ba8a4]">Affiliate Disclosure:</strong> LabLooker may earn a commission when you
        ...
        <div className="mt-6 flex flex-col items-center justify-between gap-4 border-t border-[#e0ebe9] pt-8 sm:flex-row">
          <p className="text-xs text-[#8ba8a4]">
            &copy; {new Date().getFullYear()} {APP_CONFIG.name}. All rights reserved.
          </p>
          <div className="flex gap-6">
            <a href="#" className="text-[#c5d8d5] transition-colors hover:text-[#6b8c88]" aria-label="Twitter">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
              </svg>
            </a>
            <a href="#" className="text-[#c5d8d5] transition-colors hover:text-[#6b8c88]" aria-label="GitHub">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
