...
export default function TranslatePage() {
  ...
  const handlePdfUpload = useCallback(async (file: File) => {
    ...
    try {
      ...
      if (res.status === 422) {
        setPdfError('This PDF doesn\'t contain selectable text — it may be image-based or generated by an EMR system. Try typing your test names in the box below, or copy them from your patient portal (Quest MyQuest, LabCorp Patient, etc.).')
